...
var LightNovelWPPlugin = /** @class */ (function () {
    function LightNovelWPPlugin(metadata) {
        ...
        this.version = "1.1.".concat(6 + versionIncrements);
                    ...
                    case 1:
                        ...
                        if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) {
                            try {
                                ...
                                $_1('div.entry-content script').remove();
                                $_1('div.entry-content > p').each(function (_, el) {
                                    var _a;
                                    var url = _this.site + chapterPath.slice(0, -1);
                                    var encode = url.length * url.charCodeAt(url.length - 1) * 2 % 3;
                                    var offsets = new Map([[0, 4223], [1, 12415], [2, 7007]]);
                                    var offset = (_a = offsets.get(encode)) !== null && _a !== void 0 ? _a : 4223;
                                    $_1(el).text($_1(el).text().split('').map(function (char) {
