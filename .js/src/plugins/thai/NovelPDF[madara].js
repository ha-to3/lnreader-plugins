...
var MadaraPlugin = /** @class */ (function () {
    function MadaraPlugin(metadata) {
        ...
        this.version = "1.0.".concat(6 + versionIncrements);
    ...
    MadaraPlugin.prototype.translateDragontea = function (text) {
        ...
        if (this.id !== 'dragontea')
            return text;
        var $ = (0, cheerio_1.load)(((_a = text.html()) === null || _a === void 0 ? void 0 : _a.replace('\n', '').replace(/<br\s*\/?>/g, '\n')) || '');
        ...
        text.html($.html());
        text.find('*').addBack().contents().filter(function (_, el) { return el.nodeType === 3; }).each(function (_, el) {
            var $el = $(el);
            var translated = $el.text().normalize('NFD').split('')
                .map(function (char) {
